		...
		<view class="container">
			<Card>
					...
					<template v-slot:upload>
						<view @click="onPreviewImage" :data-url="data.imgSrc" class="image_view ty-row ty-row__direction--column ty-row__align--center tr-row__justify--center">
					...
					<template v-slot:code>
						<view class="code-container">
							...
							<view v-if="activeIndex === 1" class="code-content">
								<Input name="HTML代码：" :value='"<img src=" + data.imgSrc + " />"' />								
								<Input name="Markdown：" :value='"![" + data._id + "](" + data.imgSrc + ")"' />							
							</view>
							<view v-if="activeIndex === 2" class="code-content ty-row ty-row__justify--center">
